...
__dateModified__ = "$dateModified: 2025-01-07 16:56:20 +0000 (Tue, January 07, 2025) $"
...
class SideChainAssignmentModule(PickAndAssignModule):
    ...
    def __init__(self, mainWindow, name='Sidechain Assignment'):
        ...
        self._notifier = self.setNotifier(self.project, [Notifier.RENAME, Notifier.CREATE, Notifier.CHANGE, Notifier.DELETE],
